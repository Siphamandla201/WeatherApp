document.addEventListener("DOMContentLoaded", () => {
    ...
    function fetchWeatherData() {
        ...
        .then(data => {
            ...
            const m = parseInt(date.substr(5, 7)); // Adjust the substr indexes
            const d = parseInt(date.substr(8, 2)); // Adjust the substr indexes
            const time = date.substr(11);
        
            dateOutput.innerHTML = `${dayOfTheWeek(d, m, y)} ${d}, ${m} ${y}`;  // Use location.name from the location object
